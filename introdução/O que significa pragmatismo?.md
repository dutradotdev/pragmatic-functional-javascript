<h2> O que significa "pragmatismo" </h2>
...
<h2>O autor</h2>
Marcelo Camargo é desenvolvedor e tradutor conhecido no Brasil por defender o paradigma funcional. É o criado da linguagem de programação Quack, da versão não-oficial do Skype para o Linux e contribuidor em uma dezena de projetos open-source. Se você deseja conversar sobre compiladores e teorias de tipos, você pode achá-lo fácilmente no GitHub <a href="https://github.com/haskellcamargo">/haskellcamargo</a>
